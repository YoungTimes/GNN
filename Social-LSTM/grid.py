...
def get_grid_mask(frame, dimensions, neighborhood_size, grid_size):
    ...
    for ped_index in range(mnp):
        ...
        for otherped_index in range(mnp):
            ...
            frame_mask[ped_index, otherped_index, cell_x + cell_y * grid_size] = 1
...
def get_sequence_grid_mask(sequence, dimensions, neighborhood_size, grid_size):
    ...
    for i in range(sl):
        sequence_mask[i, :, :, :] = get_grid_mask(sequence[i, :, :], dimensions, neighborhood_size, grid_size)
